...
def edit_pptx(file_path: str, out_path: str, created_datetime:datetime or None=None, last_modified_datetime: datetime or None=None, author: str or None=None):
    prs = Presentation(file_path)
    if created_datetime is not None:
        prs.core_properties.created = created_datetime
    if last_modified_datetime is not None:
        prs.core_properties.modified = last_modified_datetime
    if author is not None:
...
def process_dir(root_dir: str, out_dir: str, created_datetime:datetime or None=None, last_modified_datetime: datetime or None=None, author: str or None=None):
    ...
    for c_file in files:
        if os.path.isfile(root_dir + c_file):
            process_file(root_dir + c_file, out_dir + c_file, created_datetime, last_modified_datetime, author)
        else:
            process_dir(root_dir + c_file + '/', out_dir + c_file + '/', created_datetime, last_modified_datetime, author)
...
def process_file(root_dir: str, out_dir: str, created_datetime:datetime or None=None, last_modified_datetime: datetime or None=None, author: str or None=None):
    ...
    elif root_dir.endswith('.pptx'):
        edit_pptx(root_dir, out_dir, created_datetime, last_modified_datetime, author)
